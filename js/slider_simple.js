...
/////////////////////////////INIT///////////////////////////////////
		...
		function init(){
            ...
            $(">li", getObject.imgs).each(function(_index){
                 $(this).css({top:-521})
            })
            $(">li", getObject.imgs).eq(0).css({top:0});
...
////////////////////////////////////////////////////////////////////////////////////////////////      
		function currItemHandler(){
                ...
                $(">li", getObject.imgs).eq(_currItem).stop().animate({top:0}, 800, 'easeInOutCubic');
                $(">li", getObject.imgs).eq(_prevItem).stop().animate({top:521}, 800, 'easeInOutCubic', function(){
                    $(">li", getObject.imgs).eq(_prevItem).css({top:-521});
                } );
    	}   
////////////////////////////////////////////////////////////////////////////////////////////              
	}
